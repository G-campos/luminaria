          ...
          <div class="my-body">
            ...
            <div>
              <div>
                ...
                <input type="range" min="0" max="255" v-model="localLighting.lightIntensity" class="custom-range" @mousedown.prevent :disabled="!localLighting.power"/>
              </div>
              <div>
        ...
        <script>
          ...
          createApp({
            setup() {
              ...
              function connect() {
                socket = new WebSocket("ws://)" + ip + R"(:81");
              ...
              function togglePower() {
                if (localLighting.value.power) {
                  ...
                  localLighting.value.power = !localLighting.value.power;
                }
              }
